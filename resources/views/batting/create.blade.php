<x-app-layout>
    ...
    <div id="loading" style="position:fixed; top:0; left:0; width:100%; height:100%; z-index:1000; background-color: rgba(128, 128, 128, 0.8); opacity:0; visibility:hidden; pointer-events:none;">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const scrollToResultSelector = function() {
            if (!resultSelectorRoot) {
                return;
            }
