        ...
        <section class="mt-4 rounded-3xl border border-slate-200 bg-white p-4">
            ...
            @if($manualRunnerOptions !== [])
                <div id="manual-runner-form" class="mt-3 grid gap-3">
                    ...
                    <button type="button" data-role="manual-runner-submit" class="runner-action-button runner-action-manual">
                        走者を置く
                    </button>
                </div>
            @else
...
@once
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const submitRunnerEvent = function (payload) {
                if (!runnerEventForm) {
                    return;
                }
            ...
            runnerActionButtons.forEach(function (button) {
            ...
            if (runnerUndoButton && runnerUndoForm) {
                runnerUndoButton.addEventListener('click', function () {
            ...
            if (manualRunnerSelect) {
                manualRunnerSelect.addEventListener('change', function () {
            ...
            if (manualRunnerSubmitButton) {
                manualRunnerSubmitButton.addEventListener('click', function () {
                    if (!manualRunnerSelect || !manualRunnerTargetBase) {
                        return;
                    }
                    ...
                    submitRunnerEvent({
                        action: '{{ \App\Services\OffenseStateService::EVENT_MANUAL_PLACE }}',
    ...
    <style>
        ...
        .offense-diamond {
            ...
            box-shadow: inset 0 12px 32px rgba(255, 255, 255, 0.18);
        }
        ...
        .offense-base-chip.is-occupied {
            background: rgba(15, 23, 42, 0.9);
            color: #fff;
            border-color: rgba(255, 255, 255, 0.3);
        }

        .offense-base-chip-base {
            font-size: 0.65rem;
            font-weight: 800;
            letter-spacing: 0.08em;
        }

        .offense-base-chip-name {
            margin-top: 0.15rem;
            font-size: 0.86rem;
            font-weight: 800;
            line-height: 1.1;
