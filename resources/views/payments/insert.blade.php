...
<script>
    ...
    const paymentYearInput = document.getElementById('payment_year');
    ...
    paymentYearInput.value = date.getFullYear();
    paymentMonthSelect.value = date.getMonth()+1;
    paymentAmountInput.value = localStorage.getItem('payment_amount') || 2000;
    ...
    paymentAmountInput.addEventListener('input', function() {
        localStorage.setItem('payment_amount', paymentAmountInput.value);
    });
});
</script>
